...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name top_fdiv_32ns_32ns_32_8_no_dsp_1_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name top_fdiv_32ns_32ns_32_8_no_dsp_1_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips top_fdiv_32ns_32ns_32_8_no_dsp_1_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files top_fdiv_32ns_32ns_32_8_no_dsp_1_ip.xci]
generate_target {synthesis simulation} [get_files top_fdiv_32ns_32ns_32_8_no_dsp_1_ip.xci]
