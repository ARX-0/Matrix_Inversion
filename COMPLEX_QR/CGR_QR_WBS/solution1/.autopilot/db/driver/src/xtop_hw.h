...
#define XTOP_CONTROL_ADDR_Q_DRAM_DATA 0x1c
#define XTOP_CONTROL_BITS_Q_DRAM_DATA 64
#define XTOP_CONTROL_ADDR_R_DRAM_DATA 0x28
#define XTOP_CONTROL_BITS_R_DRAM_DATA 64
