...
HLS_SOURCES = ../../../../../top_tb.cpp ../../../../../fns.cpp ../../../../../top.cpp
...
$(ObjDir)/top_tb.o: ../../../../../top_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../top_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/top_tb.d

$(ObjDir)/fns.o: ../../../../../fns.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../fns.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fns.d
