...
define void @apatb_top_1_ir([4 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="4" "maxi" %A_DRAM, [4 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="4" "maxi" %Q_DRAM, [4 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="4" "maxi" %R_DRAM) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_top_1_hw([4 x [4 x float]]* %A_DRAM_copy, [4 x [4 x float]]* %Q_DRAM_copy, [4 x [4 x float]]* %R_DRAM_copy)
...
declare void @apatb_top_1_hw([4 x [4 x float]]*, [4 x [4 x float]]*, [4 x [4 x float]]*)
...
define void @top_1_hw_stub_wrapper([4 x [4 x float]]*, [4 x [4 x float]]*, [4 x [4 x float]]*) #5 {
entry:
  ...
  call void @top_1_hw_stub([4 x float]* %3, [4 x float]* %4, [4 x float]* %5)
...
declare void @top_1_hw_stub([4 x float]*, [4 x float]*, [4 x float]*)
