...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "top_1.autotvin.dat"
	set constFileTvOut       "top_1.autotvout.dat"
	set constFileHdlTvIn     "top_1.autohdltvin.dat"
	set constFileHdlTvOut    "top_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
