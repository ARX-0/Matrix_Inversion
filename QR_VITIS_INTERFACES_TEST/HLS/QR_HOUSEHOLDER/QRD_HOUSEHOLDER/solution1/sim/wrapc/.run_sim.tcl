...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "top_qr.autotvin.dat"
	set constFileTvOut       "top_qr.autotvout.dat"
	set constFileHdlTvIn     "top_qr.autohdltvin.dat"
	set constFileHdlTvOut    "top_qr.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
